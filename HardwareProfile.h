...
// Sample clock speed for a 16-bit processor
    ...
    #define GetSystemClock()        16000000				//@ 32 Mhz to 16 Mhz change
...
//	        #define SPIOUT              TRISFbits.TRISF8
	        ...
	        // Description: SD-SPI Chip Select Output bit
	        #define SD_CS				LATFbits.LATF4
	        // Description: SD-SPI Chip Select TRIS bit
	        #define SD_CS_TRIS			TRISFbits.TRISF4
	        
	        // Description: SD-SPI Card Detect Input bit
	        #define SD_CD               PORTEbits.RE0
	        // Description: SD-SPI Card Detect TRIS bit
	        #define SD_CD_TRIS          TRISEbits.TRISE0
	        ...
	        // Description: The TRIS bit for the SCK pin
	        #define SPICLOCK            TRISFbits.TRISF2
	        // Description: The TRIS bit for the SDI pin
	        #define SPIIN               TRISFbits.TRISF3
	        // Description: The TRIS bit for the SDO pin
...
//            
//            // Description: SD-SPI Card Detect Input bit
//            #define SD_CD               PORTFbits.RE0
//            // Description: SD-SPI Card Detect TRIS bit
//            #define SD_CD_TRIS          TRISFbits.TRISE0
//
//            // Description: SD-SPI Write Protect Check Input bit
//            #define SD_WE               PORTFbits.RF1
//            // Description: SD-SPI Write Protect Check TRIS bit
